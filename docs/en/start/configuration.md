...
To make it easy to manage different configuration values for different environments, Spiral Framework uses the [DotEnv](https://github.com/vlucas/phpdotenv) PHP library. 
...
When you install Spiral Framework, this file is automatically copied to `.env`.
